...
class Unitecentral
{
    ...
    #[ORM\ManyToOne(inversedBy: 'unitecentrals')]
     ...
     */
    #[ORM\OneToMany(targetEntity: Bureau::class, mappedBy: 'unitecentral')]
    ...
    public function removeBureau(Bureau $bureau): static
    {
        if ($this->bureaus->removeElement($bureau)) {
            ...
            if ($bureau->getUnitecentral() === $this) {
                $bureau->setUnitecentral(null);
            }
        }
