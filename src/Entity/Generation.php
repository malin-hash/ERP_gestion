...
class Generation
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Ordinateur::class, mappedBy: 'generation')]
    ...
    public function removeOrdinateur(Ordinateur $ordinateur): static
    {
        if ($this->ordinateurs->removeElement($ordinateur)) {
            ...
            if ($ordinateur->getGeneration() === $this) {
                $ordinateur->setGeneration(null);
            }
        }
